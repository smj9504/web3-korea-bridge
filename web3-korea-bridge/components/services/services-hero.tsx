  ...
  const stats = [
    {
      ...
      description: t('hero.stats.experienceDesc')
    },
    {
      icon: Users,
      value: '50+',
    ...
    },
    {
      ...
      description: t('hero.stats.successDesc')
    }
  ]

  return (
    <section className="relative min-h-[80vh] flex items-center justify-center bg-gradient-to-br from-background via-background to-secondary/20">
      {/* Background Pattern */}
